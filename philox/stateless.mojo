...
@always_inline
fn generate_u16[Rounds: UInt8 = 10](key: UInt16x2, ctr: UInt16x4) -> UInt16x4:
    return generate_any[Rounds](key, ctr)

@always_inline
fn generate_u32[Rounds: UInt8 = 10](key: UInt32x2, ctr: UInt32x4) -> UInt32x4:
    return generate_any[Rounds](key, ctr)

@always_inline
fn generate_u64[Rounds: UInt8 = 10](key: UInt64x2, ctr: UInt64x4) -> UInt64x4:
    return generate_any[Rounds](key, ctr)

@always_inline
fn generate_f16[Rounds: UInt8 = 10](key: UInt16x2, ctr: UInt16x4) -> Float16x4:
    var rng = generate_u16[Rounds](key, ctr)
    return asfloat[DType.float16](rng)

@always_inline
fn generate_f32[Rounds: UInt8 = 10](key: UInt32x2, ctr: UInt32x4) -> Float32x4:
    var rng = generate_u32[Rounds](key, ctr)
    return asfloat[DType.float32](rng)

@always_inline
fn generate_f64[Rounds: UInt8 = 10](key: UInt64x2, ctr: UInt64x4) -> Float64x4:
